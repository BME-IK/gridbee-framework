...
henkolib.async.AsyncOperation.prototype.setResult = function(result) {
	...
	if(this.state == henkolib.async.AsyncState.Waiting) {
		...
		haxe.Timer.delay(function() {
			$s.push("henkolib.async.AsyncOperation::setResult@65");
			var $spos = $s.length;
			self.result = result;
		...
		henkolib.log.Console.main.logError("Async operation result can only be set once!",null,null,{ fileName : "AsyncOperation.hx", lineNumber : 76, className : "henkolib.async.AsyncOperation", methodName : "setResult"});
	}
	$s.pop();
}
henkolib.async.AsyncOperation.prototype.setError = function(error) {
	...
	if(this.state == henkolib.async.AsyncState.Waiting) {
		...
		henkolib.log.Console.main.logError("Async operation error can only be set once!",null,null,{ fileName : "AsyncOperation.hx", lineNumber : 90, className : "henkolib.async.AsyncOperation", methodName : "setError"});
	}
	$s.pop();
}
...
gridbee.worksource.boinc.BoincWorkSource.prototype.init = function() {
	...
	if(this.host.host_info.p_fpops == 0) {
		...
		benchmark.onComplete.subscribe(function(c) {
			$s.push("gridbee.worksource.boinc.BoincWorkSource::init@122");
			var $spos = $s.length;
			self.host.host_info.p_fpops = benchmark.getFlops();
			self.updateHostInfo();
			self.benchmarkpool.removeCompleted();
			henkolib.log.Console.main.logInformation("Benchmark successfully executed.",null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 127, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "init"});
			$s.pop();
		});
		benchmark.onError.subscribe(function(e) {
			$s.push("gridbee.worksource.boinc.BoincWorkSource::init@129");
			var $spos = $s.length;
			henkolib.log.Console.main.logError("Benchmark error: " + e,null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 131, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "init"});
			self.benchmarkpool.removeCompleted();
			$s.pop();
		});
	...
	if(this.host.host_info.p_fpops != 0) {
		if(this.workpool.getNumInit() + this.workpool.getNumPassive() == 0 && !this.requestinprogress) {
			...
			newworks.onComplete.subscribe(function(wus) {
				$s.push("gridbee.worksource.boinc.BoincWorkSource::startOne@154");
				var $spos = $s.length;
				var _g = 0;
				while(_g < wus.length) {
					var wu = wus[_g];
					...
					henkolib.log.Console.main.logInformation("New workunit recieved",null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 160, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "startOne"});
				}
				$s.pop();
			});
			newworks.onError.subscribe(function(errormes) {
				$s.push("gridbee.worksource.boinc.BoincWorkSource::startOne@164");
				var $spos = $s.length;
				henkolib.log.Console.main.logNotice(errormes,null,null,{ fileName : "BoincWorkSource.hx", lineNumber : 166, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "startOne"});
				$s.pop();
			});
		}
...
gridbee.worksource.boinc.BoincWorkSource.prototype.requestWorks = function() {
	...
	request.setWorkRequest(new gridbee.worksource.boinc.request.WorkRequest(10));
	{
		...
		while(_g < _g1.length) {
			var work = _g1[_g];
			++_g;
			henkolib.log.Console.main.logInformation("Reporting uploaded results to: " + this.getScreenName(),null,work,{ fileName : "BoincWorkSource.hx", lineNumber : 231, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
	...
	http.successCallback(function(response) {
		$s.push("gridbee.worksource.boinc.BoincWorkSource::requestWorks@241");
		var $spos = $s.length;
		henkolib.log.Console.main.logInformation("Received Boinc Scheduler reply.",null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 243, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
		...
		if(reply.hostid != null) {
			...
			henkolib.log.Console.main.logNotice("Registered new host: " + reply.hostid,null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 253, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
			henkolib.log.Console.main.logNotice("Project name: " + reply.project_name,null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 254, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
			henkolib.log.Console.main.logNotice("Username: " + reply.user_name,null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 255, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
		}
		{
			...
			while(_g < _g1.length) {
				var ack = _g1[_g];
				++_g;
				henkolib.log.Console.main.logInformation("Received result ack: " + ack.name,null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 263, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
				{
					...
					while(_g2 < _g3.length) {
						...
						if(work.getWorkUnitResultName() == ack.name) {
							...
							henkolib.log.Console.main.logNotice("Reported result accepted. WorkUnit removed.",null,work,{ fileName : "BoincWorkSource.hx", lineNumber : 269, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
		...
		}
		{
			...
			while(_g < _g1.length) {
				var message = _g1[_g];
				++_g;
				henkolib.log.Console.main.logNotice("BOINC " + message.priority + " priority message: " + message.message,null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 280, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
			}
		}
	...
	henkolib.log.Console.main.logInformation("Sending Boinc Scheduler request.",null,this,{ fileName : "BoincWorkSource.hx", lineNumber : 355, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
	http.send();
	{
		$s.pop();
		return result;
...
gridbee.worksource.boinc.BoincWorkSource.prototype.reportWork = function(work) {
	...
	var $spos = $s.length;
	henkolib.log.Console.main.logInformation("Added to reporting queue: " + work.getScreenName(),null,this,{ fileName : "BoincWorkSource.hx", lineNumber : 363, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "reportWork"});
...
gridbee.core.work.hxjson2.JSON.encode = function(o) {
	$s.push("gridbee.core.work.hxjson2.JSON::encode");
	var $spos = $s.length;
	{
		var $tmp = new gridbee.core.work.hxjson2.JSONEncoder(o).getString();
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
gridbee.core.work.hxjson2.JSON.decode = function(s,strict) {
	$s.push("gridbee.core.work.hxjson2.JSON::decode");
	var $spos = $s.length;
	if(strict == null) strict = true;
	{
		var $tmp = new gridbee.core.work.hxjson2.JSONDecoder(s,strict).getValue();
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
gridbee.core.work.hxjson2.JSON.stringify = function(o) {
	$s.push("gridbee.core.work.hxjson2.JSON::stringify");
	var $spos = $s.length;
	{
		var $tmp = new gridbee.core.work.hxjson2.JSONEncoder(o).getString();
		$s.pop();
...
gridbee.core.work.hxjson2.JSON.parse = function(s,strict) {
	$s.push("gridbee.core.work.hxjson2.JSON::parse");
	var $spos = $s.length;
	if(strict == null) strict = true;
	{
		var $tmp = new gridbee.core.work.hxjson2.JSONDecoder(s,strict).getValue();
...
gridbee.core.work.hxjson2.JSONDecoder = function(s,strict) { if( s === $_ ) return; {
	$s.push("gridbee.core.work.hxjson2.JSONDecoder::new");
	var $spos = $s.length;
	this.strict = strict;
...
gridbee.core.work.hxjson2.JSONDecoder.prototype.getValue = function() {
	$s.push("gridbee.core.work.hxjson2.JSONDecoder::getValue");
	var $spos = $s.length;
	{
		var $tmp = this.value;
		$s.pop();
...
gridbee.core.work.hxjson2.JSONDecoder.prototype.nextToken = function() {
	$s.push("gridbee.core.work.hxjson2.JSONDecoder::nextToken");
	var $spos = $s.length;
	{
...
gridbee.core.work.hxjson2.JSONDecoder.prototype.parseArray = function() {
	$s.push("gridbee.core.work.hxjson2.JSONDecoder::parseArray");
	var $spos = $s.length;
	var a = new Array();
	this.nextToken();
	if(this.token.type == gridbee.core.work.hxjson2.JSONTokenType.tRIGHT_BRACKET) {
		{
			$s.pop();
			return a;
		}
		...
		if(!this.strict && this.token.type == gridbee.core.work.hxjson2.JSONTokenType.tCOMMA) {
			this.nextToken();
			if(this.token.type == gridbee.core.work.hxjson2.JSONTokenType.tRIGHT_BRACKET) {
				{
					$s.pop();
	...
	while(true) {
		...
		else if(this.token.type == gridbee.core.work.hxjson2.JSONTokenType.tCOMMA) {
			this.nextToken();
			if(!this.strict) {
				if(this.token.type == gridbee.core.work.hxjson2.JSONTokenType.tRIGHT_BRACKET) {
					{
...
gridbee.core.work.hxjson2.JSONDecoder.prototype.parseObject = function() {
	$s.push("gridbee.core.work.hxjson2.JSONDecoder::parseObject");
	var $spos = $s.length;
	var o = { };
	var key;
	this.nextToken();
	if(this.token.type == gridbee.core.work.hxjson2.JSONTokenType.tRIGHT_BRACE) {
		{
			$s.pop();
			return o;
		}
	...
	while(true) {
		if(this.token.type == gridbee.core.work.hxjson2.JSONTokenType.tSTRING) {
...
gridbee.core.work.hxjson2.JSONDecoder.prototype.parseValue = function() {
	$s.push("gridbee.core.work.hxjson2.JSONDecoder::parseValue");
	var $spos = $s.length;
...
gridbee.core.work._NaClWorker.NaClWorker_StringOnly.isSupported = function() {
	$s.push("gridbee.core.work._NaClWorker.NaClWorker_StringOnly::isSupported");
	var $spos = $s.length;
...
gridbee.core.work._NaClWorker.NaClWorker_StringOnly.prototype._onprogress = function(evt) {
	...
	var $spos = $s.length;
	haxe.Log.trace(evt.type,{ fileName : "NaClWorker.hx", lineNumber : 89, className : "gridbee.core.work._NaClWorker.NaClWorker_StringOnly", methodName : "_onprogress"});
	$s.pop();
}
...
gridbee.core.work._NaClWorker.NaClWorker_StringOnly.prototype.onerrorSetter = function(func) {
	...
	var $spos = $s.length;
	haxe.Log.trace("onerrorSetter called",{ fileName : "NaClWorker.hx", lineNumber : 117, className : "gridbee.core.work._NaClWorker.NaClWorker_StringOnly", methodName : "onerrorSetter"});
	if(func != null) {
		if(!this.onerrorQueue.isEmpty()) haxe.Log.trace("  sending content of queue",{ fileName : "NaClWorker.hx", lineNumber : 120, className : "gridbee.core.work._NaClWorker.NaClWorker_StringOnly", methodName : "onerrorSetter"});
		var evt;
		while((evt = this.onerrorQueue.pop()) != null) {
			haxe.Log.trace("    sent",{ fileName : "NaClWorker.hx", lineNumber : 123, className : "gridbee.core.work._NaClWorker.NaClWorker_StringOnly", methodName : "onerrorSetter"});
			func(evt);
		}
...
gridbee.core.work._NaClWorker.NaClWorker_StringOnly.prototype._onerror = function(origEvent) {
	...
	var $spos = $s.length;
	haxe.Log.trace("_onerror called",{ fileName : "NaClWorker.hx", lineNumber : 137, className : "gridbee.core.work._NaClWorker.NaClWorker_StringOnly", methodName : "_onerror"});
	var errorEvent = new ErrorEvent();
	errorEvent.message = this.naclElement.lastError;
	if(this.onerrorGetter() != null) {
		haxe.Log.trace("  handing it off to onerror",{ fileName : "NaClWorker.hx", lineNumber : 143, className : "gridbee.core.work._NaClWorker.NaClWorker_StringOnly", methodName : "_onerror"});
		(this.onerrorGetter())(errorEvent);
	}
	else {
		haxe.Log.trace("  queueing it",{ fileName : "NaClWorker.hx", lineNumber : 146, className : "gridbee.core.work._NaClWorker.NaClWorker_StringOnly", methodName : "_onerror"});
...
gridbee.core.work._NaClWorker.NaClWorker_StringOnly.prototype.onmessageSetter = function(func) {
	...
	var $spos = $s.length;
	haxe.Log.trace("onmessageSetter called",{ fileName : "NaClWorker.hx", lineNumber : 160, className : "gridbee.core.work._NaClWorker.NaClWorker_StringOnly", methodName : "onmessageSetter"});
	if(func != null) {
		if(!this.onmessageQueue.isEmpty()) haxe.Log.trace("  sending content of queue",{ fileName : "NaClWorker.hx", lineNumber : 163, className : "gridbee.core.work._NaClWorker.NaClWorker_StringOnly", methodName : "onmessageSetter"});
		var evt;
		while((evt = this.onmessageQueue.pop()) != null) {
			haxe.Log.trace("    sent",{ fileName : "NaClWorker.hx", lineNumber : 166, className : "gridbee.core.work._NaClWorker.NaClWorker_StringOnly", methodName : "onmessageSetter"});
			func(evt);
		}
...
gridbee.core.work._NaClWorker.NaClWorker_StringOnly.prototype.onmessageGetter = function() {
	$s.push("gridbee.core.work._NaClWorker.NaClWorker_StringOnly::onmessageGetter");
	var $spos = $s.length;
	{
		var $tmp = this.onmessageTheRealOne;
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
gridbee.core.work._NaClWorker.NaClWorker_StringOnly.prototype._onmessage = function(evt) {
	...
	var $spos = $s.length;
	haxe.Log.trace("_onmessage called",{ fileName : "NaClWorker.hx", lineNumber : 177, className : "gridbee.core.work._NaClWorker.NaClWorker_StringOnly", methodName : "_onmessage"});
	if(this.onmessageGetter() != null) {
		haxe.Log.trace("  handing it off to onmessage",{ fileName : "NaClWorker.hx", lineNumber : 179, className : "gridbee.core.work._NaClWorker.NaClWorker_StringOnly", methodName : "_onmessage"});
		(this.onmessageGetter())(evt);
	}
	else {
		haxe.Log.trace("  queueing it",{ fileName : "NaClWorker.hx", lineNumber : 182, className : "gridbee.core.work._NaClWorker.NaClWorker_StringOnly", methodName : "_onmessage"});
...
gridbee.core.work.NaClWorker.isSupported = function() {
	$s.push("gridbee.core.work.NaClWorker::isSupported");
	var $spos = $s.length;
	{
		var $tmp = gridbee.core.work._NaClWorker.NaClWorker_StringOnly.isSupported();
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
gridbee.core.work.NaClWorker.prototype._onmessage = function(evt) {
	...
	var $spos = $s.length;
	haxe.Log.trace("_onmessage JSON wrapper called with " + evt.data,{ fileName : "NaClWorker.hx", lineNumber : 52, className : "gridbee.core.work.NaClWorker", methodName : "_onmessage"});
	try {
...
gridbee.core.work.NaClWorker.prototype.postMessage = function(message) {
	...
	var $spos = $s.length;
	haxe.Log.trace("postMessage JSON wrapper called with " + message,{ fileName : "NaClWorker.hx", lineNumber : 66, className : "gridbee.core.work.NaClWorker", methodName : "postMessage"});
...
gridbee.core.work.hxjson2.JSONToken = function(type,value) { if( type === $_ ) return; {
	$s.push("gridbee.core.work.hxjson2.JSONToken::new");
	var $spos = $s.length;
...
gridbee.core.work.hxjson2.JSONParseError = function(message,location,text) { if( message === $_ ) return; {
	$s.push("gridbee.core.work.hxjson2.JSONParseError::new");
	var $spos = $s.length;
	if(text == null) text = "";
...
gridbee.core.work.hxjson2.JSONParseError.prototype.getlocation = function() {
	$s.push("gridbee.core.work.hxjson2.JSONParseError::getlocation");
	var $spos = $s.length;
	{
...
gridbee.core.work.hxjson2.JSONParseError.prototype.gettext = function() {
	$s.push("gridbee.core.work.hxjson2.JSONParseError::gettext");
	var $spos = $s.length;
	{
		var $tmp = this._text;
		$s.pop();
...
gridbee.core.work.hxjson2.JSONParseError.prototype.toString = function() {
	$s.push("gridbee.core.work.hxjson2.JSONParseError::toString");
	var $spos = $s.length;
	{
...
gridbee.core.work.WorkContext.prototype.setPlatform = function(p) {
	$s.push("gridbee.core.work.WorkContext::setPlatform");
	var $spos = $s.length;
	this.platform = p;
	$s.pop();
}
...
gridbee.core.work.WorkContext.prototype.getPlatform = function() {
	$s.push("gridbee.core.work.WorkContext::getPlatform");
	var $spos = $s.length;
	{
		var $tmp = this.platform;
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
gridbee.worksource.boinc.BoincWorkUnit = function(unit,platform) { if( unit === $_ ) return; {
...
gridbee.core.work.WorkExecutor.prototype.operate = function() {
	...
	if(this.start && this.context.isAvailable()) {
		this.start = false;
		if(this.context.getPlatform() == "nacl") {
			this.worker = new gridbee.core.work.NaClWorker(this.temp.getProgramCode());
		}
		else {
...
gridbee.core.work.hxjson2.JSONTokenizer = function(s,strict) { if( s === $_ ) return; {
	$s.push("gridbee.core.work.hxjson2.JSONTokenizer::new");
	var $spos = $s.length;
	this.jsonString = s;
	this.strict = strict;
	this.loc = 0;
...
gridbee.core.work.hxjson2.JSONTokenizer.prototype.getNextToken = function() {
	$s.push("gridbee.core.work.hxjson2.JSONTokenizer::getNextToken");
	var $spos = $s.length;
...
gridbee.core.work.hxjson2.JSONTokenizer.prototype.readString = function() {
	$s.push("gridbee.core.work.hxjson2.JSONTokenizer::readString");
	var $spos = $s.length;
	var string = "";
	this.nextChar();
...
gridbee.core.work.hxjson2.JSONTokenizer.prototype.hexValToInt = function(hexVal) {
	$s.push("gridbee.core.work.hxjson2.JSONTokenizer::hexValToInt");
	var $spos = $s.length;
	var ret = 0;
	{
...
gridbee.core.work.hxjson2.JSONTokenizer.prototype.readNumber = function() {
	$s.push("gridbee.core.work.hxjson2.JSONTokenizer::readNumber");
	var $spos = $s.length;
	var input = "";
	if(this.ch == "-") {
		input += "-";
...
gridbee.core.work.hxjson2.JSONTokenizer.prototype.nextChar = function() {
	$s.push("gridbee.core.work.hxjson2.JSONTokenizer::nextChar");
	var $spos = $s.length;
	{
...
gridbee.core.work.hxjson2.JSONTokenizer.prototype.skipIgnored = function() {
	$s.push("gridbee.core.work.hxjson2.JSONTokenizer::skipIgnored");
	var $spos = $s.length;
	var originalLoc;
	do {
...
gridbee.core.work.hxjson2.JSONTokenizer.prototype.skipComments = function() {
	$s.push("gridbee.core.work.hxjson2.JSONTokenizer::skipComments");
	var $spos = $s.length;
	if(this.ch == "/") {
		this.nextChar();
		switch(this.ch) {
...
gridbee.core.work.hxjson2.JSONTokenizer.prototype.skipWhite = function() {
	$s.push("gridbee.core.work.hxjson2.JSONTokenizer::skipWhite");
	var $spos = $s.length;
...
gridbee.core.work.hxjson2.JSONTokenizer.prototype.isWhiteSpace = function(ch) {
	$s.push("gridbee.core.work.hxjson2.JSONTokenizer::isWhiteSpace");
	var $spos = $s.length;
	{
		var $tmp = ch == " " || ch == "\t" || ch == "\n" || ch == "\r";
		$s.pop();
...
gridbee.core.work.hxjson2.JSONTokenizer.prototype.isDigit = function(ch) {
	$s.push("gridbee.core.work.hxjson2.JSONTokenizer::isDigit");
	var $spos = $s.length;
	{
		var $tmp = ch >= "0" && ch <= "9";
		$s.pop();
...
gridbee.core.work.hxjson2.JSONTokenizer.prototype.isHexDigit = function(ch) {
	$s.push("gridbee.core.work.hxjson2.JSONTokenizer::isHexDigit");
	var $spos = $s.length;
...
gridbee.core.work.hxjson2.JSONTokenizer.prototype.parseError = function(message) {
	$s.push("gridbee.core.work.hxjson2.JSONTokenizer::parseError");
	var $spos = $s.length;
